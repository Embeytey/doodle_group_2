    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meeting', models.ForeignKey(blank=True, db_column='meeting_id', on_delete=django.db.models.deletion.CASCADE, to='api.meeting')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='meeting',
            name='final_date',
            field=models.ForeignKey(blank=True, db_column='final_date', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='meetings', to='api.timeslot'),
        ),
        migrations.AddField(
            model_name='meeting',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(db_column='id', primary_key=True, serialize=False)),
                ('preference', models.ForeignKey(db_column='preference_id', on_delete=django.db.models.deletion.CASCADE, to='api.preference')),
